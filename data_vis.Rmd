...
```
 ...
 Create clean data frame for table 1, c
```{r}
...
mutate(
    ...
    ventilator_dependence = factor(ventilat, ordered = TRUE, levels = c("Yes", "No")),
    asthma = factor(asthma, ordered = TRUE, levels = c("Yes", "No")),
    home_oxygen = factor(oxygen_sup, ordered = TRUE, levels = c("Yes", "No")),
    cognitive_impairment = factor(impcogstat, ordered = TRUE, levels = c("Yes", "No")),
    seizure_disorder = factor(seizure, ordered = TRUE, levels = c("Yes", "No")),
    nutritional_support = factor(nutr_support, ordered = TRUE, levels = c("Yes", "No")),
    hematologic_disorder = factor(hemodisorder, ordered = TRUE, levels = c("Yes", "No"))
)
