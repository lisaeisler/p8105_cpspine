...
```
The chi-square provides a p-value=0.0028 (p< 0.05), thus, our reduced model as a whole fits significantly better than the null model. 
...
2. Having a pre-existing hematologic disorder decreases the log odds of being discharged to home by 1.309.

Although asthma, and level of fusion did not appear as significant in the model, we provide them here as they are clinically significant and connected to post-surgery complications and outcomes in the literature.
3. Having asthma  decreases the log odds of being discharged to home by 0.372
4. Having a level of fusion more than 13 decreases the log odds of being discharged at home by 0.179 
...
```
##Data interpretation
For every one year  increase in age, the odds of being discharged home (versus being discharged to another health care facility) increase by 0.82. This means that for every year increase in age the odds of being release to a health care facility (not home) increase by (1/.82=1.22) by 22%.
The odds of being discharged at home if you have a hemodisorder are 0.27.This means that if the patient has a pre-existing hematologic disorder the odds of being discharged to a health care facility are (1/.27=3.7) 3.7 the odds of being discharged to home. 
Important pre-operative indicators such as asthma,and level of fusion did not appear as significant in the model, we provide them here for consideration for future research. 
If a patient has asthma the odds of being discharged to home are 0.69.That is the odds of being released to a health care facility (not home) increase by (1/.82=1.44) by 44%. If a patient has a fusion level 13 and above the odds of being discharged home are 0.83.That is the odds of being released to a health care facility (not home) increase by (1/.82=1.44) by 20%.
